...
const mapModule = (() => {
  ...
  // ~1,000 hazards per click: dense local clusters + Washington scatter,
  // then US cities and major world cities, so every click populates the globe
  // while keeping the local demo area rich.
  const SEED_CLUSTERS = [
    ...
    // Washington scatter: Seattle metro, Tacoma, Everett, Olympia, Spokane,
    // Tri-Cities, Bellingham, Vancouver WA, Yakima, Wenatchee.
    {
      name: 'Washington scatter',
      lat: 47.4, lng: -121.8, count: 100, radius: 1.9,
      spread: [
    ...
    // Major US cities, 20 each.
    {
      name: 'US cities',
      lat: 39.8, lng: -98.5, count: 420, radius: 0.2,
      spread: [
    ...
    // Major world cities, 25 each.
    {
      name: 'World cities',
      lat: 20.0, lng: 0.0, count: 425, radius: 0.2,
      spread: [
